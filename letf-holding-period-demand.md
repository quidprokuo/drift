...
The pattern: across asset classes, leverage levels, and underlying types, a significant share of LETF AUM is held materially longer than the design intent. The capital is *trying* to buy buy-and-hold leverage. The product they are using does not deliver that.
